...
if (!isset($_SESSION['fbUserId']) and $_SESSION['fbUserId'] == "") {
	header('location: http://localhost/web01/facebok/index.php');
	exit;} ?>
...
<body>
	<div class="container">
		<h1 class="text-center"><a href="http://localhost/web01/facebok/index.php">Login Facebook</a></h1>
		<div class="row">
			<div class="col-sm-12 text-center p-5">
				<p>Welcome <em class="text-danger">
				<?php 
				
				echo $_SESSION['fbUserName'];?></em></p>
