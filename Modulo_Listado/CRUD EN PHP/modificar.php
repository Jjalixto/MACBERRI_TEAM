...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form class="col-4 p-3 m-auto" method="POST">
            <h3 class="text-center text-secondary">Modificar de personas</h3>
            <input type="hidden" name ="id" value ="<?= $_GET["id"] ?>">
                ...
                <div class="mb-1">
                    ...
                    <?php }
                ?>
            <button type="submit" class="btn btn-primary" name="btnmodificar" value="OK">Modificar datos de la persona</button>
    </form>
<!-- /.content-wrapper -->
