...
include "../modelo/conexion.php";
        ...
        $llamada = "INSERT INTO users(correo,clave,rol)
                    VALUES('$correo', '$clave','')";
        $consulta_repet = "SELECT correo,clave  FROM users WHERE correo = '$correo'";            
        $verificar_correo = mysqli_query($conexion,$consulta_repet);
        ...
        $ejecutar = mysqli_query($conexion,$llamada);
